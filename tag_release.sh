...
MESSAGE=""
FILE=""
VERSION_HEADER_FILE="include/Core/version.h"
...
#pragma once
#define CORE_VERSION_STR "${VERSION}"
#define CORE_VERSION_MAJOR $(echo "$VERSION" | cut -d. -f1)
#define CORE_VERSION_MINOR $(echo "$VERSION" | cut -d. -f2)
#define CORE_VERSION_PATCH $(echo "$VERSION" | cut -d. -f3)
#define CORE_VERSION_BUILD $(echo "$VERSION" | cut -d. -f4)
EOF
